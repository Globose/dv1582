...
class ShipOfFoolsGame:
    ...
    def turn(self):
        ...
        for _ in range(3):
            ...
            if not has_ship and self._cup.has_value(6):
                has_ship = True
                
            if has_ship and not has_captain and self._cup.has_value(5):
                has_captain = True

            if has_captain and not has_mate and self._cup.has_value(4):
                has_mate = True
...
class PlayRoom:
    ...
    def print_winner(self):
        print("{}: {}".format("Winner",self._winner.get_name()))
